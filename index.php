				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							<p class="subtitle">Handicraft</p>
							<h1>Handicraft Heaven</h1>
							<div class="hero-btns">
								<a href="shop.php" class="boxed-btn">Handicraft Collection</a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="assets/img/Echair.jpg" alt=""></a>
						</div>
						<h3>Eco-Friendly</h3>
						<p class="product-price"><span>Per Kg</span> 35$ </p>
						<a href="cart.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
                	...
                	<div class="image">
                    	<div class="price-box">
                        	<div class="inner-price">
                                <span class="price">
                                    <strong>30%</strong> <br> off per 1 pices
                                </span>
                            </div>
                        </div>
                    	<img src="assets/img/Bnatya.jpg" alt="">
                    </div>
                </div>
                <!--Content Column-->
                <div class="content-column col-lg-6">
					<h3><span class="orange-text">Deal</span> of the month</h3>
                    <h4>Handicraft Products</h4>
